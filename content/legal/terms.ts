...
export const terms: LegalDoc = {
  ...
  "sections": [
    ...
    {
      "heading": "NO OFFER, RECOMMENDATION OR SOLICITATION",
      "level": 2,
      "blocks": [
    ...
    {
      "heading": "FORWARD-LOOKING STATEMENTS AND VIRTUAL CURRENCY-RELATED INFORMATION",
      "level": 2,
      "blocks": [
    ...
    {
      "heading": "USER SUBMISSIONS: GRANT OF LICENCE",
      "level": 2,
      "blocks": [
    ...
    {
      "heading": "ARBITRATION AND WAIVER OF CLASS ACTION",
      "level": 2,
      "blocks": [
    ...
    },
    {
      ...
      "level": 2,
      "blocks": [
        "To file a complaint, obtain information about our policies and practices, or if you have questions or comments about these Terms of Use, please contact us by email at [info@eratree.io](mailto:info@eratree.io)."
      ]
    }
  ]
};
