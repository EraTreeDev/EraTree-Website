...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Risk Disclosure", description: "Terms, conditions and inherent risks associated with virtual asset transactions conducted through EraTree.", url: "/risk-disclosure" },
